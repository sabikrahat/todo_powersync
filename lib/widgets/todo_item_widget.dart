...
import '../attachments/photo_widget.dart';
...
class TodoItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
        ...
        title: Row(
          children: <Widget>[
            Expanded(child: Text(todo.description, style: _getTextStyle(todo.completed))),
            IconButton(
              iconSize: 30,
              icon: const Icon(
                Icons.delete,
            ...
            AppConfig.supabaseStorageBucket.isEmpty ? Container() : PhotoWidget(todo: todo),
          ],
        ));
  }
}
